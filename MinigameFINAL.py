...
programleder_bakgrunn = pygame.image.load("/home/pi/elsysgame/programleder_valg.png")
resultat_bakgrunn = pygame.image.load("/home/pi/elsysgame/resultat_side.png")
...
def resultater(spill_vinner):
    ...
    #screen.fill('orange')
    text_font = pygame.font.Font('/home/pi/elsysgame/pen_font.ttf', 40)
    text_font_overskirft = pygame.font.Font('/home/pi/elsysgame/pen_font.ttf', 100)

# Definerer innhold som skal rendres:
    #text_overskrift = text_font.render(
        #'Vinneren av Nytt på Nytt Mini game Show er: ', True, 'White')
    screen.blit(resultat_bakgrunn, (0,0))
    text_vinner = text_font_overskirft.render(spill_vinner, True, 'white')

# Rendrer ut på skjermen:
    #screen.blit(text_overskrift, (250, 200))
    screen.blit(text_vinner, (730, 525))
...
def player_selection(rando_int, player_int):
    ...
    sel_arrow_X = start_pos_x
    sel_arrow_Y = pos_y_higher
    ...
    while n < 2:
        ...
        if (pre_next_p1 and not s_next_p1) and player_int == 1:
            ...
            if (sel_arrow_X == start_pos_x) and (sel_arrow_Y == pos_y_higher):
                sel_arrow_X = pos_x_2
            elif sel_arrow_X == pos_x_2 and sel_arrow_Y == pos_y_higher:
                sel_arrow_X = pos_x_3
            elif sel_arrow_X == pos_x_3 and sel_arrow_Y == pos_y_higher:
                sel_arrow_X = pos_x_4
                sel_arrow_Y = pos_y_lower
            elif sel_arrow_X == pos_x_4 and sel_arrow_Y == pos_y_lower:
                sel_arrow_X = pos_x_5
            else:
                sel_arrow_X = start_pos_x
                sel_arrow_Y = pos_y_higher
        ...
        if (pre_select_p1 and not s_select_p1) and player_int == 1:
            print("Svar angitt")
            if (sel_arrow_X == start_pos_x) and (sel_arrow_Y == pos_y_higher) and (len(word_comb) == 0):
                word_comb = ord_dict[rando_int][0]
                n += 1
            elif (sel_arrow_X == start_pos_x) and (sel_arrow_Y == pos_y_higher) and (len(word_comb) > 1):
                word_comb += ord_dict[rando_int][0]
                n += 1
            if (sel_arrow_X == pos_x_2) and (sel_arrow_Y == pos_y_higher) and (len(word_comb) == 0):
                word_comb = ord_dict[rando_int][1]
                n += 1
            elif (sel_arrow_X == pos_x_2) and (sel_arrow_Y == pos_y_higher) and (len(word_comb) > 0):
                word_comb += ord_dict[rando_int][1]
                n += 1
            if (sel_arrow_X == pos_x_3) and (sel_arrow_Y == pos_y_higher) and (len(word_comb) == 0):
                word_comb = ord_dict[rando_int][2]
                n += 1
            elif (sel_arrow_X == pos_x_3) and (sel_arrow_Y == pos_y_higher) and (len(word_comb) > 0):
                word_comb += ord_dict[rando_int][2]
                n += 1
            if (sel_arrow_X == pos_x_4) and (sel_arrow_Y == pos_y_lower) and (len(word_comb) == 0):
                word_comb = ord_dict[rando_int][3]
                n += 1
            elif (sel_arrow_X == pos_x_4) and (sel_arrow_Y == pos_y_lower) and (len(word_comb) > 0):
                word_comb += ord_dict[rando_int][3]
                n += 1
            if (sel_arrow_X == pos_x_5) and (sel_arrow_Y == pos_y_lower) and (len(word_comb) == 0):
                word_comb = ord_dict[rando_int][4]
                n += 1
            elif (sel_arrow_X == pos_x_5) and (sel_arrow_Y == pos_y_lower) and (len(word_comb) > 0):
                word_comb += ord_dict[rando_int][4]
                n += 1
        ...
        text_to_screen(word_comb, 590, 250)
        text_to_screen(ord_dict[rando_int][0], 315, 520)
        text_to_screen(ord_dict[rando_int][1], 790, 520)
        text_to_screen(ord_dict[rando_int][2], 1265, 520)
        text_to_screen(ord_dict[rando_int][3], 550, 760)
        text_to_screen(ord_dict[rando_int][4], 1035, 760)
...
def score(answer_p1, answer_p2):
    ...
    white = [255, 255, 255]
    #screen.fill('orange')
    screen.blit(programleder_bakgrunn, (0,0))

    # ELEMENTS
    text_font = pygame.font.Font('/home/pi/elsysgame/pen_font.ttf', 40)  # Delete after merge if duplicate
    ...
    text_answer_p1 = text_font.render(answer_p1, True, white)
    text_answer_p2 = text_font.render(answer_p2, True, white)
    ...
    screen.blit(text_answer_p1, (150, 675))  # Answer_p1
    screen.blit(text_answer_p2, (1100, 675))  # Answer_p2
