...
# Rendrer her innholdet i tekstboksene basert på font og innhold:
    ...
    screen.blit(text_overskrift, (600, 100))
    screen.blit(text_surface_overskrift, (200, 300))
    screen.blit(text_surface_avsnitt1, (200, 380))
    screen.blit(text_surface_avsnitt2, (200, 420))
    screen.blit(text_surface_avsnitt3, (200, 460))
    screen.blit(text_surface_avsnitt4, (200, 500))
    screen.blit(text_surface_avsnitt5, (200, 540))
    screen.blit(text_surface_avsnitt6, (200, 580))
    screen.blit(text_surface_avsnitt7, (200, 620))
    screen.blit(text_surface_avsnitt8, (200, 660))
    screen.blit(text_surface_avsnitt9, (200, 1050))
...
def player_selection(rando_int, player_int):
    ...
    while n < 2:
        ...
        if (pre_select_p1 and not s_select_p1) or player_int == 1:
            print("Svar angitt")
